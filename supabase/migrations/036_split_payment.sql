-- Tambah kolom split_payment_detail untuk menyimpan rincian pembayaran campuran
-- Format JSONB: { "cash_amount": 50000, "second_method": "transfer", "second_amount": 30000 }
ALTER TABLE transactions
  ADD COLUMN IF NOT EXISTS split_payment_detail JSONB DEFAULT NULL;

-- Update RPC process_transaction untuk terima dan simpan split_payment_detail
  ...
  WHILE NOT v_inserted AND v_retry < 10 LOOP
    ...
    BEGIN
      INSERT INTO transactions (
        ...
        split_payment_detail, created_at, updated_at
      ) VALUES (
        ...
        p_split_payment_detail, p_created_at, p_created_at
      );
      v_inserted := TRUE;
