  ...
  const renderProductCard = ({ item }: { item: Product }) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => router.push(`/(owner)/products/${item.id}` as any)}
        onLongPress={() => {
    ...
    <View style={styles.container}>
      <OwnerPageHeader
        ...
        rightElement={
          <TouchableOpacity
            style={styles.catBtn}
            onPress={() => router.push("/(owner)/products/categories")}
          >
      ...
      <TouchableOpacity
        ...
        onPress={() => router.push("/(owner)/products/form")}
      >
        ...
        >
          <View style={styles.menuContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                setShowMenu(false);
                router.push(`/(owner)/products/form?id=${selectedProduct?.id}`);
              }}
            >
