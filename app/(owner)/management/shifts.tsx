      ...
      <View style={cardStyles.row}>
        ...
        <View style={{ flex: 1 }}>
          <View style={cardStyles.topRow}>
            <Text style={cardStyles.cashierName} numberOfLines={1}>{shift.cashier_name}</Text>
          ...
          <Text style={cardStyles.branch} numberOfLines={1}>{shift.branch_name}</Text>
...
const cardStyles = StyleSheet.create({
  ...
  branch: { fontSize: 12, color: '#56B2C1', fontWeight: '600', marginBottom: 2 },
        ...
        {loading ? (
          ...
          >
            ...
            <View style={detailStyles.infoCard}>
              ...
              <View style={detailStyles.infoRow}>
                <Text style={detailStyles.infoLabel}>Cabang</Text>
                <Text style={detailStyles.infoValue}>{detail.branch_name}</Text>
              </View>
              <View style={detailStyles.divider} />
              <View style={detailStyles.infoRow}>
              ...
              <View style={detailStyles.infoRow}>
                ...
                <Text style={detailStyles.infoValue}>{fmtDuration(detail.opened_at, detail.closed_at)}</Text>
              </View>
              {detail.notes ? (
                <>
                  <View style={detailStyles.divider} />
                  <View style={detailStyles.infoRow}>
                    ...
                    <Text style={[detailStyles.infoValue, { flex: 1, textAlign: 'right' }]}>{detail.notes}</Text>
                  </View>
                </>
              ) : null}
            </View>
            ...
            <View style={detailStyles.summaryGrid}>
              ...
              <View style={detailStyles.summaryItem}>
                ...
                <Text style={detailStyles.summaryValue}>{fmtMoney(detail.summary.transferSales)}</Text>
              </View>
              <View style={detailStyles.summaryItem}>
            ...
            {detail.transactions.length > 0 && (
              <>
                <Text style={detailStyles.sectionTitle}>Transaksi ({detail.transactions.length})</Text>
        ...
        {branches.length > 1 && (
          <View style={styles.branchFilterWrap}>
            ...
            >
              ...
              >
                <Text style={[styles.chipText, selectedBranch === 'all' && styles.chipTextActive]}>
                  Semua Cabang
                </Text>
              </TouchableOpacity>
              {branches.map((b) => (
                ...
                >
                  <Text style={[styles.chipText, selectedBranch === b.id && styles.chipTextActive]}>
                    {b.name}
                  </Text>
                </TouchableOpacity>
              ))}
